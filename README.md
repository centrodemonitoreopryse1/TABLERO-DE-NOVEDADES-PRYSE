[index.html.html](https://github.com/user-attachments/files/32666613/index.html.html)
<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Tablero de Guardia — Bitácora 23 ves – 24 mat / 09/2026</title>
...
<style>
  ...
  *{box-sizing:border-box} html,body{margin:0;padding:0}
  ...
  .sub{color:var(--text-muted); font-size:14px; max-width:780px}
...
<div class="masthead">
  <div>
    ...
    <h1>Tablero de Avances — 23 ves / 24 mat · Sep 2026</h1>
    <div class="sub">Periodo: cierres vespertinos 23, matutinos 24, códigos plata, SV (Kevin D. Maldonado), incidentes de seguridad y nota informativa CECOE. 1 FT (Baja California vespertino) · 14/14 OOAD con ambos cierres.</div>
  </div>
  <div class="status-pill"><span class="dot"></span> 1 FT · 9 SV · 45/46 completos</div>
</div>
...
<div class="wrap">
  ...
  <section>
    <div class="section-head">
      ...
      <span class="section-title">Línea de tiempo — matutinos 24/09</span>
      <span class="section-note">05:00 – 07:00 · 14/14 a tiempo</span>
    </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th class="num">Ves 23</th><th class="num">Mat 24</th>
            <th class="num">FT</th><th class="num">SV</th><th>Estatus</th>
          </tr>
        </thead>
  ...
  <section>
    ...
    <div class="two-col">
      <div>
        <div class="section-title" style="font-size:14px;color:var(--red);margin-bottom:10px">Fuera de tiempo / faltantes</div>
        <div id="devList"></div>
  ...
  <section>
    <div class="section-head">
      ...
      <span class="section-note">Matutinos 24/09</span>
    </div>
    <div class="reg-grid">
...
<footer>
  <span>Fuente: TABLA 23 Y 24 SEP 2026.xlsx</span>
  <span>Tablero de avances · 23–24/09/2026</span>
</footer>

<script>
const DASH = {
  "meta": {
    "fecha": "23 ves – 24 mat / 09/2026",
    "total_filas": 46,
    "registros_reales": 46,
    "ooad_count": 14,
    "completo": 45,
  ...
  "errores": [
    "Folio 4672 BAJA CALIFORNIA · REPORTE VESPERTINO 23/09 a las 21:59: ESTATUS FUERA DE TIEMPO (único FT del periodo).",
    "SLA vacío en la mayoría de registros; solo la NOTA INFORMATIVA de CECOE (folio 4700) tiene contenido en SLA.",
    "Sinaloa reporta 3 códigos plata en permanencia tanto en cierre vespertino 23 como matutino 24.",
    "Typo en folio 4701 (CÓDIGO ROSA): \"SE NTREGA\" → debería ser \"SE ENTREGA\".",
    "Horarios de zona: BCS, Sonora, Sinaloa y Baja California reportan diferencia por horario de zona en sus cierres.",
    "Cobertura SV del periodo: 9 OOAD con SV. Sin SV: COAHUILA, CHIHUAHUA, SAN LUIS POTOSÍ, ZACATECAS.",
    "No hay reportes matutinos ni vespertinos faltantes de los 14 OOAD operativos.",
    "Monitoreo realizado por Kevin Daniel Maldonado (22:00 del 23 y 06:00 del 24)."
  ],
  "ooad_summary": [
    {"ooad": "AGUASCALIENTES", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "RICARDO NANDI", "estatus": "OK", "sv": 1, "hora_mat": "06:21", "ves23": 1, "mat24": 1},
    {"ooad": "BAJA CALIFORNIA", "total": 2, "completo": 1, "fuera": 1, "incomp": 0, "coordinador": "EDGAR ACOSTA ESCARCEGA", "estatus": "DESVIACIÓN", "sv": 0, "hora_mat": "05:50", "ves23": 1, "mat24": 1},
    {"ooad": "BAJA CALIFORNIA SUR", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "LEONCIO CORONADO GALINDO", "estatus": "OK", "sv": 1, "hora_mat": "05:00", "ves23": 1, "mat24": 1},
    {"ooad": "CHIHUAHUA", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "HECTOR GABRIEL BOLLY", "estatus": "OK", "sv": 0, "hora_mat": "06:47", "ves23": 1, "mat24": 1},
    {"ooad": "COAHUILA", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "CESAR FRANCISCO CEDILLO PEREZ", "estatus": "OK", "sv": 0, "hora_mat": "06:25", "ves23": 1, "mat24": 1},
    {"ooad": "DURANGO", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "HECTOR ALFONSO LUJAN FLORIANO", "estatus": "OK", "sv": 1, "hora_mat": "06:33", "ves23": 1, "mat24": 1},
    {"ooad": "JALISCO", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "MARIO ALBERTO FLORES ALEISSA", "estatus": "OK", "sv": 1, "hora_mat": "06:00", "ves23": 1, "mat24": 1},
    {"ooad": "NAYARIT", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "AARON RICARDO PALMA ROMAN", "estatus": "OK", "sv": 1, "hora_mat": "06:01", "ves23": 1, "mat24": 1},
    {"ooad": "NUEVO LEÓN", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "JOSE ANTONIO RAMOS AGUILAR", "estatus": "OK", "sv": 1, "hora_mat": "06:06", "ves23": 1, "mat24": 1},
    {"ooad": "SAN LUIS POTOSÍ", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "LUCIA RAPETA QUIRINO", "estatus": "OK", "sv": 0, "hora_mat": "06:09", "ves23": 1, "mat24": 1},
    {"ooad": "SINALOA", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "RAUL GALLARDO VELÀZQUEZ", "estatus": "OK", "sv": 1, "hora_mat": "05:31", "ves23": 1, "mat24": 1},
    {"ooad": "SONORA", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "GUSTAVO ALONSO RASCON EVANS", "estatus": "OK", "sv": 1, "hora_mat": "05:01", "ves23": 1, "mat24": 1},
    {"ooad": "TAMAULIPAS", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "RONALD HERNANDEZ", "estatus": "OK", "sv": 1, "hora_mat": "06:20", "ves23": 1, "mat24": 1},
    {"ooad": "ZACATECAS", "total": 2, "completo": 2, "fuera": 0, "incomp": 0, "coordinador": "EDUARDO AYALA LOPEZ", "estatus": "OK", "sv": 0, "hora_mat": "06:00", "ves23": 1, "mat24": 1}
  ],
  "deviations": [
    {
      "folio": 4672,
      "ooad": "BAJA CALIFORNIA",
      "incidencia": "REPORTE VESPERTINO",
      "hora": "21:59",
      "fecha": "23/09/2026",
  ...
  "hitos": [
    {
      "folio": 4656,
      "ooad": "SINALOA",
      "incidencia": "ALTA DE CODIGO PLATA",
      "hora": "09:30",
      "fecha": "23/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "HGZ#3",
      "municipio": "MAZATLAN SINALOA",
      "observaciones": "SE DA DE ALTA PACIENTE INGRESADO POR HERIDA DE ARMA DE FUEGO ACOMPAÑADO DE FAMILIAR"
    },
    {
      "folio": 4657,
      "ooad": "SAN LUIS POTOSÍ",
      "incidencia": "ROTURA DE CRISTAL",
      "hora": "11:15",
      "fecha": "23/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "HGZ#50",
      "municipio": "SAN LUIS POTOSI",
      "observaciones": "SE INFORMA LA ROTURA DE UNA PUERTA DE CRISTAL POR EL IMPACTO DE UNA BALA PERDIDA"
    },
    {
      "folio": 4658,
      "ooad": "NAYARIT",
      "incidencia": "INGRESO DE CODIGO PLATA",
      "hora": "14:17",
      "fecha": "23/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "HR#22",
      "municipio": "SAN CAYETANO",
      "observaciones": "INGRESAN PACIENTE POR HERIDA DE ARMA DE FUEGO CUSTODIADO POR EJERCITO MEXICANO"
    },
    {
      "folio": 4674,
      "ooad": "SAN LUIS POTOSÍ",
      "incidencia": "CAIDA DE PUERTA DE CRISTAL",
      "hora": "20:59",
      "fecha": "23/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "HGZ#6",
      "municipio": "CD VALLES",
      "observaciones": "INFORMAN LA CAIDA DE PUERTA DE CRISTAL DEL HGZ"
    },
    {
      "folio": 4684,
      "ooad": "IMSS CENTRALES",
    ...
    },
    {
      "folio": 4700,
      "ooad": "IMSS CENTRALES",
      "incidencia": "NOTA INFORMATIVA",
      "hora": "10:04",
      "fecha": "24/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "CECOE",
      "municipio": "",
      "observaciones": "INTEGRA NOTA SOBRE POSIBLES MANIFESTACIONES DE TRABAJADORES DEL IMSS Y NECESITA ESTAR ATENTOS A LAS UNIDADES MEDICAS POR POSIBLES DESASTRES"
    },
    {
      "folio": 4701,
      "ooad": "SAN LUIS POTOSÍ",
      "incidencia": "CODIGO ROSA",
      "hora": "11:00",
      "fecha": "24/09/2026",
      "estatus": "REPORTADO COMPLETO",
      "unidad": "HGZ#1",
      "municipio": "SAN LUIS POTOSI",
      "observaciones": "SE ACTIVA CODIGO ROSA POR PERDIDA DE MENOR DE EDAD EXTRAVIANDOSE EN EL AREA DE CONSULTORIOS. SE ACTIVAN PROTOCOLOS DE SEGURIDAD, SE ENCUENTRA EN LABORATORIOS Y SE ENTREGA CON SU MADRE"
    }
  ],
  "sv_list": [
    {"ooad": "BAJA CALIFORNIA SUR", "unidad": "UMF#40", "municipio": "BAJA CALIFORNIA SUR", "hora": "22:40", "fecha": "23/09/2026"},
    {"ooad": "JALISCO", "unidad": "UMF#8", "municipio": "JALISCO", "hora": "23:00", "fecha": "23/09/2026"},
    {"ooad": "TAMAULIPAS", "unidad": "CEBIS", "municipio": "TAMPICO", "hora": "23:17", "fecha": "23/09/2026"},
    {"ooad": "SINALOA", "unidad": "UMF#31", "municipio": "EL ROSARIO", "hora": "23:36", "fecha": "23/09/2026"},
    {"ooad": "AGUASCALIENTES", "unidad": "HGZ#1", "municipio": "AGUASCALIENTES", "hora": "00:07", "fecha": "24/09/2026"},
    {"ooad": "SONORA", "unidad": "UMF#62", "municipio": "SONORA", "hora": "00:48", "fecha": "24/09/2026"},
    {"ooad": "NUEVO LEÓN", "unidad": "UMF#27", "municipio": "NUEVO LEON", "hora": "01:18", "fecha": "24/09/2026"},
    {"ooad": "DURANGO", "unidad": "UMF#41", "municipio": "DURANGO", "hora": "01:40", "fecha": "24/09/2026"},
    {"ooad": "NAYARIT", "unidad": "UMF#24", "municipio": "NAYARIT", "hora": "02:09", "fecha": "24/09/2026"}
  ],
  "missing_sv": ["COAHUILA", "CHIHUAHUA", "SAN LUIS POTOSÍ", "ZACATECAS"],
  "regression": {
    "n": 14,
    "umbral": "N/A",
    "curve": [
      {"hora": "05:00", "minutos": 300, "prob": 0.0},
      {"hora": "05:05", "minutos": 305, "prob": 0.0},
      {"hora": "05:10", "minutos": 310, "prob": 0.0},
      {"hora": "05:15", "minutos": 315, "prob": 0.0},
      {"hora": "05:20", "minutos": 320, "prob": 0.0},
      {"hora": "05:25", "minutos": 325, "prob": 0.0},
      {"hora": "05:30", "minutos": 330, "prob": 0.0},
      {"hora": "05:35", "minutos": 335, "prob": 0.0},
      {"hora": "05:40", "minutos": 340, "prob": 0.0},
      {"hora": "05:45", "minutos": 345, "prob": 0.0},
      {"hora": "05:50", "minutos": 350, "prob": 0.0},
      {"hora": "05:55", "minutos": 355, "prob": 0.0},
      {"hora": "06:00", "minutos": 360, "prob": 0.0},
      {"hora": "06:05", "minutos": 365, "prob": 0.0},
      {"hora": "06:10", "minutos": 370, "prob": 0.0},
      {"hora": "06:15", "minutos": 375, "prob": 0.0},
      {"hora": "06:20", "minutos": 380, "prob": 0.0},
      {"hora": "06:25", "minutos": 385, "prob": 0.0},
      {"hora": "06:30", "minutos": 390, "prob": 0.0},
      {"hora": "06:35", "minutos": 395, "prob": 0.0},
      {"hora": "06:40", "minutos": 400, "prob": 0.0},
      {"hora": "06:45", "minutos": 405, "prob": 0.0},
      {"hora": "06:50", "minutos": 410, "prob": 0.0},
      {"hora": "06:55", "minutos": 415, "prob": 0.0},
      {"hora": "07:00", "minutos": 420, "prob": 0.0}
    ],
    "points": [
      {"ooad": "BAJA CALIFORNIA SUR", "hora": "05:00", "minutos": 300, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "SONORA", "hora": "05:01", "minutos": 301, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "SINALOA", "hora": "05:31", "minutos": 331, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "BAJA CALIFORNIA", "hora": "05:50", "minutos": 350, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "ZACATECAS", "hora": "06:00", "minutos": 360, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "JALISCO", "hora": "06:00", "minutos": 360, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "NAYARIT", "hora": "06:01", "minutos": 361, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "NUEVO LEÓN", "hora": "06:06", "minutos": 366, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "SAN LUIS POTOSÍ", "hora": "06:09", "minutos": 369, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "TAMAULIPAS", "hora": "06:20", "minutos": 380, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "AGUASCALIENTES", "hora": "06:21", "minutos": 381, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "COAHUILA", "hora": "06:25", "minutos": 385, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "DURANGO", "hora": "06:33", "minutos": 393, "fuera_tiempo": 0, "fecha": "24/09"},
      {"ooad": "CHIHUAHUA", "hora": "06:47", "minutos": 407, "fuera_tiempo": 0, "fecha": "24/09"}
    ],
    "note": "Regresión sobre matutinos 24/09 (14/14). 0 FT en cierres mat. Rango 05:00–06:47. FT del periodo es vespertino BC 23/09 21:59."
  }
};
</script>
<script>
...
document.getElementById('kpiGrid').innerHTML = [
  {label:'Registros totales', val:m.registros_reales, foot:`Ves23 ${m.ves23} · Mat24 ${m.mat24}`, cls:'accent-teal'},
  {label:'Reportado completo', val:m.completo, foot:'1 FT · 0 incompletos formales', cls:'accent-green'},
  {label:'Fuera de tiempo', val:m.fuera, foot:'BC vespertino 23/09 21:59', cls:'accent-red'},
  {label:'Supervisiones SV', val:m.sv_count, foot:`${(DASH.missing_sv||[]).length} OOAD sin SV`, cls:'accent-amber'},
  {label:'OOAD con desviación', val:DASH.ooad_summary.filter(o=>o.estatus!=='OK').length, foot:'Solo BC (FT vespertino)', cls:'accent-red'},
...
const minStart = 300, minEnd = 450;
let hourMarks = '';
for (let h = 5; h <= 7; h++) {
  const pct = ((h * 60) - minStart) / (minEnd - minStart) * 100;
  hourMarks += `<div class="hm" style="left:${pct}%">${String(h).padStart(2,'0')}:00</div>`;
}
...
document.getElementById('ooadTableBody').innerHTML = sorted.map(o => {
  const badge = o.estatus === 'OK'
    ...
    : '<span class="badge miss"><span class="badge-dot"></span>FT</span>';
  return `<tr>
    <td style="font-family:var(--display);font-weight:600">${o.ooad}</td>
    <td class="muted">${o.coordinador || '—'}</td>
    <td class="num">${o.ves23}</td>
    <td class="num">${o.mat24}</td>
    <td class="num" style="color:${o.fuera ? 'var(--red)' : 'var(--text-dim)'}">${o.fuera}</td>
...
document.getElementById('devList').innerHTML = DASH.deviations.length
  ...
  <div class="dev-item">
    ...
    <div class="loc">${d.ooad} · Folio ${d.folio} · ${d.fecha}</div>
...
document.getElementById('regStats').innerHTML = `
  <div class="stat-box"><div class="k">Casos FT mat 24</div><div class="v" style="color:var(--green)">0</div></div>
  <div class="stat-box"><div class="k">N muestras</div><div class="v">${reg.n}</div></div>
  <div class="stat-box"><div class="k">Más temprano</div><div class="v">05:00</div></div>
  <div class="stat-box"><div class="k">Más tardío</div><div class="v">06:47</div></div>`;
document.getElementById('regNotes').innerHTML = `
  <li><b>Regresión logística no estimable</b> en cierres matutinos 24/09: 0 FT.</li>
  <li>El único FT del periodo es <b>vespertino Baja California 23/09 a las 21:59</b> (folio 4672).</li>
  <li>Todos los 14 OOAD enviaron tanto vespertino 23 como matutino 24.</li>
  <li>Cierres mat 24 entre BCS 05:00 y Chihuahua 06:47.</li>
  <li>${reg.note || ''}</li>`;
...
new Chart(document.getElementById('regChart'), {
  ...
  data: {
    ...
    datasets: [
      ...
      {
        label: 'Observados 24/09',
        data: reg.curve.map(c => {
          const pt = reg.points.find(p => Math.abs(p.minutos - c.minutos) < 3);
          return pt ? 0 : null;
        }),
